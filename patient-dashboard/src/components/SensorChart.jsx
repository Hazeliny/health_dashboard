        ...
        if (isBloodPressure) {
          ...
          return (
            <div key={index} 
              ...
              >
              {/* Title */}
              <h4 className="text-lg font-semibold mb-0 whitespace-pre-line dark:text-gray-600">{card.title}</h4>
          ...
          return (
            <div key={index} className="group p-4 border rounded shadow-sm relative cursor-pointer hover:shadow-lg hover:border-blue-600 transition" onClick={() => handleCardClick(card.key)}
              title="Click to view visual monitor"
            >
              <h4 className="text-lg font-semibold mb-4 whitespace-pre-line dark:text-gray-600">{card.title}</h4>
